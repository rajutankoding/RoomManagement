...
// Penting: Gunakan variabel let atau state global jika Anda ingin mockBookings benar-benar berubah
// Untuk tujuan demo, kita akan membiarkannya sebagai const dan mengubahnya secara lokal
// di dalam fungsi, tapi ingat ini TIDAK merekomendasikan untuk produksi
let initialMockBookings = {
  // <--- Diubah menjadi 'let' agar bisa dimodifikasi
...
export default function Calendar() {
  ...
  const [bookingsData, setBookingsData] = useState(initialMockBookings);
